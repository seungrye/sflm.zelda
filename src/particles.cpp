 ...
 */
void ParticleEffect::update_sprite(std::shared_ptr<SpriteTexture> sprite)
{
...
std::shared_ptr<SpriteTexture> AnimationPlayer::create_particles(const py::Vector2f &pos, const std::string &attack_type)
{
