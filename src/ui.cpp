...
void UI::display(std::shared_ptr<Player> player)
{
...
const py::Rect<float> UI::selection_box(float left, float top, bool has_switched)
{
...
void UI::weapon_overlay(int weapon_index, bool has_switched)
{
    sf::RenderTexture &renderTexture = GameWindow::instance().screen();
...
void UI::magic_overlay(int magic_index, bool has_switched)
{
    sf::RenderTexture &renderTexture = GameWindow::instance().screen();
...
void UI::show_bar(float current, float max_amount, const py::Rect<float> &bg_rect, const sf::Color &color)
{
    sf::RenderTexture &renderTexture = GameWindow::instance().screen();
